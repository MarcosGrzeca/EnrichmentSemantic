...
$tweets = query("SELECT id, textEmbedding
                FROM tweets_amazon
                WHERE errorEmbedding = 0
                AND textParser <> textEmbedding
                LIMIT 500");

$ind = 0;
 foreach (getRows($tweets) as $key => $value) {
    $totalErros = 0;
    $originalText = $value["textEmbedding"];
    $texto = clear($value["textEmbedding"]);
...
function removeTextualEmojis($text) {
    $textualEmojis = array("<3", "</3", ":')", ":'-)", ":D", ":-D", "=D", ":)", ":-)", "=]", "=)", ":]", "':)", "':-)", "'=)", "':D", "':-D", "'=D", ">:)", ">;)", ">:-)", ">=)", ";)", ";-)", "*-)", "*)", ";-]", ";]", ";D", ";^)", "':(", "':-(", "'=(", ":*", ":-*", "=*", ":^*", ">:P", "X-P", "x-p", ">:[", ":-(", ":(", ":-[", ":[", "=(", ">:(", ">:-(", ":@", ":'(", ":'-(", ";(", ";-(", ">.<", "D:", ":$", "=$", "#-)", "#)", "%-)", "%)", "X)", "X-)", "*\\0/*", "\\0/", "*\\O/*", "\\O/", "O:-)", "0:-3", "0:3", "0:-)", "0:)", "0;^)", "O:-)", "O:)", "O;-)", "O=)", "0;-)", "O:-3", "O:3", "B-)", "B)", "8)", "8-)", "B-D", "8-D", "-_-", "-__-", "-___-", ">:\\", ">:/", ":-/", ":-.", ":/", ":\\", "=/", "=\\", ":L", "=L", ":P", ":-P", "=P", ":-p", ":p", "=p", ":-Þ", ":Þ", ":þ", ":-þ", ":-b", ":b", "d:", ":-O", ":O", ":-o", ":o", "O_O", ">:O", ":-X", ":X", ":-#", ":#", "=X", "=x", ":x", ":-x", "=#", ";P");
